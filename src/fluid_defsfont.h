...
void sfont_close (SFData * sf, const fluid_fileapi_t * fapi);
...
/* functions */
SFData *sfload_file (const char * fname, fluid_sfloader_t * loader);
...
int fluid_defsfont_load_sampledata(fluid_defsfont_t* sfont, fluid_sfloader_t * loader);
